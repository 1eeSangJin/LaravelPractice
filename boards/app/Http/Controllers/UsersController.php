...
class UsersController extends Controller
{
    ...
    public function confirm($code){
         ...
         * 2. 그런 레코드가 없으면 회원 가입 페이지로 redirect
         * 3. 있으면 activated 값을ㄹ 1로 변경하고
         * 4. confirm_code를 null로 변경하고 db에 save
         * 5. 로그인 시켜주고
         * 6. 메인페이지로 이동
         */
        ...
        \Auth::login($user);
        return redirect(route('bbs.index'))->with('message', $user->name . '님 환영합니다.');
    }
}
